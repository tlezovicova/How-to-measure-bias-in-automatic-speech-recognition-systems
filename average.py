...
def plot_bias_metrics():
    ...
    data_path = "average_metric_results.csv"  # Update the path if necessary
...
# Plot DC-HMI metrics
    ...
    fig.savefig("average_metrics_plot.png")
...
if __name__ == "__main__":
    ...
    bias_metrics_pivot.to_csv('average_metric_results.csv', index=False)
